...
public interface EventService {
        EventDTO createEvent(String title, String eventType, LocalDate enableDate, LocalDate expireDate,
        ...
        List<EventDTO> getOwnEvents(String username);

        EventDTO updateEvent(Long id, String title, String eventType, LocalDate enableDate, LocalDate expireDate,
                        MultipartFile image, String status, String username) throws Exception;
